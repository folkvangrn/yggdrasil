...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/api/users/workers").hasAnyAuthority("worker", "manager")
                ...
                .antMatchers("/api/requests/**/activities").hasAnyAuthority("manager", "worker")
                .antMatchers("/api/activities**").hasAnyAuthority("manager", "worker")
                .antMatchers("/api/activity-dictionary**").hasAnyAuthority("manager", "worker")
